...
<body>
	<div class="p-3 mb-2 bg-light text-dark">
		...
		<div class="p-2">
		 	<h2 class="d-flex justify-content-center">〜${fn:escapeXml(groupsNameList.groupName)}〜</h2> 
		</div>
		...
		<table class="table table-bordered">
			...
			<form:form action="/nomalMessageSearch" modelAttribute="result" method="POST">
				...
				<tbody>
					...
					<c:forEach items="${messageSerach}" var="serach">
						<tr>
							...
							<form:form action="/nomalMessageTextPage" modelAttribute="result" method="get">
		...
		<div class=m-1>
				...
				<form:form action="/nomalUserGroupList" modelAttribute="result" method="GET">
