...
<body>
	...
	<div class="background-color">
			...
			<table class="table table-bordered">
				<thead>
					<c:forEach items="${sendMessageList}" var="sendMessageAll">
						<tr>
							<td>日付:/${fn:escapeXml(sendMessageAll.createDatatime)}
								<br>
								名前:/${fn:escapeXml(sendMessageAll.userName)} 
								<br> 
								<div class="hidden_box">
									<input type="checkbox" name="checkbox" value="1" id="check"> ボックスを押す
							...
							<td>
								<form:form action="/sendMessageDelete" modelAttribute="result" method="post">
									<form:hidden path="messageSend" value="${fn:escapeXml(sendMessageAll.messageSend)}" />
		...
		<form:form action="/messagereply" modelAttribute="result" method="post">
				<div class="d-flex justify-content-center">
